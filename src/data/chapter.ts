...
export const getUniqueClasses = (data: Chapter[]): string[] => {
  return Array.from(new Set(data.map(item => item.class)));
};

export const getUniqueUnits = (data: Chapter[]): string[] => {
  return Array.from(new Set(data.map(item => item.unit)));
};

export const getUniqueStatuses = (data: Chapter[]): string[] => {
